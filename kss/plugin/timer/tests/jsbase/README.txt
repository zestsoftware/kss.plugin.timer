...
The modules, with a short description:
  ...
  * dom.js
    ...
    functionality to help with XML DOM manipulation and querying
...
Special thanks go out to 'the Health Agency' in Rotterdam, the Netherlands, who
allowed me to write part of the libs during their working hours...
